    ...
    <div class="container">
        ...
        <div class="content">
            <div class="autentification flex">
                <form action="userRegistration.php" class="autentification__form" method="post">
                    <p>Логин: <input type="text" name="login" id="login"></p>
                    <p>Пароль: <input type="password" name="password" id="password"></p>
                    <p><a href="login.php">Есть аккаунт</a> <input type="submit" value="Зарегистрироваться"></p>
                </form>
            </div>
        </div>
